...
@MountPath("DeleteTerminal")
public class DeleteTerminal extends SelectTerminal{
    @SpringBean
    private ITerminalService terminalService;
    /*@SpringBean
    private ISectionService sectionService;*/

    public DeleteTerminal(Terminal selectedTerminal) {
        //入力のためのモデル
        ...
        var terminalInfoForm = new Form<>("terminalInfo") {
            ...
            protected void onSubmit() {
                ...
                terminalService.deleteTerminal(selectedTerminal.getTerminalId());
